        ...
        return (
            <div>
                ...
                <header className="vh-100 dt w-100">
                    <div className="dtc v-mid tc ph4 pv4">
                        <h1 className="mt2 mb0 firasans fw6 f2 f1-ns">Nomad</h1>
                        <div className="f5 f3-ns">
                            <p className="fw6 lh-copy mw8 center firasans" dangerouslySetInnerHTML={{ __html: this.state.intro.title }}></p>
                            <p className="lh-copy mw8 center firasans" dangerouslySetInnerHTML={{ __html: this.state.intro.text }}></p>
                        </div>
                        <div className="cf mw7 center">
                            <a className="link dim gray dib h2 w2 br-100 mr3 " href="https://twitter.com/i/moments/1059806320642138112"
                                title="">
                                <svg data-icon="twitter" viewBox="0 0 32 32" fill="currentColor">
                                    <path d="M2 4 C6 8 10 12 15 11 A6 6 0 0 1 22 4 A6 6 0 0 1 26 6 A8 8 0 0 0 31 4 A8 8 0 0 1 28 8 A8 8 0 0 0 32 7 A8 8 0 0 1 28 11 A18 18 0 0 1 10 30 A18 18 0 0 1 0 27 A12 12 0 0 0 8 24 A8 8 0 0 1 3 20 A8 8 0 0 0 6 19.5 A8 8 0 0 1 0 12 A8 8 0 0 0 3 13 A8 8 0 0 1 2 4"></path>
                                </svg>
                            </a>
                            <a className="link dim gray dib br-100 h2 w2 mr3 " href="https://instagram.com/nomadproject.uk" title="">
                            ...
                            <a className="link dim gray dib br-100 h2 w2 mr3 " href="mailto:info@nomad-project.co.uk" title="info@nomad-project.co.uk">
                                <svg aria-hidden="true" data-prefix="fas" data-icon="envelope" className="svg-inline--fa fa-envelope fa-w-16"
